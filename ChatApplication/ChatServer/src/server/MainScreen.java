...
//hien thi ip
	...
	public MainScreen() {
		...
		//openCloseButton.setBackground(Color);
		openCloseButton.setForeground(new Color(102,204,0));

		clientTable = new JTable(new Object[][] {}, new String[] { "Tên client", "Port client" });
		clientTable.setRowHeight(25);
		clientTable.setForeground(new Color(0,255,0));
...
//diaaplay hien thi loi ve login
	@Override
	//ve server
...
//tao server moi,port moi,ip moi
	public void updateClientTable() {
		...
		clientTable.setForeground(new Color(128,128,128));
	}
}
