...
connectedServerInfoJList.setForeground(new Color(0,0,255));
		...
		onlineUserScrollPane.setBackground(Color.GREEN);
		...
		groupListScrollPane.setForeground(new Color(0,0,255));
		...
		createGroupButton.setForeground(new Color(0,0,255));
		...
		JButton sendButton, fileButton, emojiButton, audioButton,callButton;

		sendButton = new JButton("Gửi");
		sendButton.setActionCommand("send");
		sendButton.addActionListener(this);
		sendButton.setForeground(new Color(0,0,255));

		 
		callButton = new JButton(Main.getScaledImage("/video-call.jpg", 16, 16));
		callButton.setActionCommand("Call");
		callButton.setForeground(new Color(0,0,255));
...
//		});
		...
		emojiButton.setForeground(new Color(0,0,255));
		
		fileButton = new JButton(Main.getScaledImage("/fileIcon.png", 16, 16));
		fileButton.setActionCommand("file");
		fileButton.addActionListener(this);
		fileButton.setForeground(new Color(0,0,255));
		audioButton = new AudioButton();
		audioButton.setForeground(new Color(0,0,255));
		...
		enterMessagePanel.add(callButton, gbc.setGrid(6, 1));
		...
		roomUsersJList.setBackground(Color.white);
